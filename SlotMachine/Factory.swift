...
//  SlotMachine
//
//  Created by GEST Precision on 2/23/15.
...
//class func - not need for anything else in the code other than class - save memory etc.
    class func createSlots () -> [[Slot]] {
        ...
        for var containerNumber = 0; containerNumber < kNumberOfContainers; ++containerNumber {
            ...
            //mySlotArray = slot[0] / slot1 slot2 slot3
