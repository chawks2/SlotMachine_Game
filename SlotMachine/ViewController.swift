...
//  SlotMachine
//
//  Created by GEST Precision on 2/20/15.
...
class ViewController: UIViewController {
    ...
    func setupContainerViews() {
        //encapsulate information set border for templates
    ...
    func setupFourthContainer(containerView: UIView) {
        ...
        //title may or may not exist thus need question mark
    ...
    func removeSlotImageViews () {
        if self.secondContainer != nil {
            //optional because the second container may have nil value
